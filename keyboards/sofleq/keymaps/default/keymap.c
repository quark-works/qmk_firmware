...
#define BASE_MULT 1.0
#define STEP 0.1

int current_mult = BASE_MULT;
...
[_QWERTY] = LAYOUT(
  KC_GRV,   KC_SPUP,   KC_SPDN,    KC_3,    KC_4,    KC_5,                     KC_6,    KC_7,    KC_8,    KC_9,    KC_0,  KC_GRV,
 ...
 */
[_RAISE] = LAYOUT(
  _______, _______ , _______ , _______ , _______ , _______,                           _______,  _______  , _______,  _______ ,  KC_SPDN ,KC_SPUP,
...
report_mouse_t pointing_device_task_user(report_mouse_t mouse_report) {
    ...
    mouse_report.x = mouse_report.x * current_mult;
    mouse_report.y = mouse_report.y * current_mult;
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case KC_LEND:
            ...
            break;
        case KC_SPUP:
            current_mult = current_mult + STEP;
            break;
        case KC_SPDN:
            current_mult = current_mult - STEP;
            break;
